...
export const TestGeneratorIcon = (props: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
...
export const AutomationIcon = (props: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      ...
      <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 10.5V15" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 7.5v.008" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M18.375 12H19.5" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 4.625V3.5" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M15.375 6.625l.791-.792" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M15.375 17.375l.791.792" />
    </svg>
);

export const DocumentsIcon = (props: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 17.25v3.375c0 .621-.504 1.125-1.125 1.125h-9.75c-.621 0-1.125-.504-1.125-1.125V7.5c0-.621.504-1.125 1.125-1.125h7.5" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M15 3.75zM15 3.75v3.375c0 .621.504 1.125 1.125 1.125h3.375M15 3.75l3.375 3.375" />
    </svg>
);
...
export const TraceabilityIcon = (props: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
...
export const AnalyticsIcon = (props: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      ...
      <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 4.5l3.75 3.75" />
...
export const IntegrationsIcon = (props: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 21v-7.5a.75.75 0 01.75-.75h3a.75.75 0 01.75.75V21m-4.5 0H2.25a.75.75 0 01-.75-.75v-10.5a.75.75 0 01.75-.75h19.5a.75.75 0 01.75.75v10.5a.75.75 0 01-.75.75h-4.5m-4.5 0v-4.5A.75.75 0 0110.5 12h3a.75.75 0 01.75.75v4.5" />
